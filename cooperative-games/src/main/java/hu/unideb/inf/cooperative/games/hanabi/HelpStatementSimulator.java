...
public class HelpStatementSimulator extends Operator {

    protected List<Formula> statement;

    public HelpStatementSimulator(List<Formula> statement) {
    ...
    public String toString() {
        return "HelpStatementSimulator: " + statement;
    }

    public List<Formula> getStatement() {
        return statement;
    }
}
